...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO docentes (tipo_documento, numero_documento, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, lugar_nacimiento, fecha_nacimiento, sexo, fecha_ingreso, especialidad)
    VALUES ('$tipo_documento', '$numero_documento', '$primer_nombre', '$segundo_nombre', '$primer_apellido', '$segundo_apellido', '$lugar_nacimiento', '$fecha_nacimiento', '$sexo', '$fecha_ingreso', '$especialidad')";

    if ($conn->query($sql) === TRUE) {
        $mensaje = "Nuevo docente registrado exitosamente";
    } else {
...
<head>
    ...
    <title>Registrar Docente - Colegio Americano de Barranquilla</title>
...
<body>
    <div class="container">
        ...
        <?php endif; ?>
        <form method="POST" action="registrar_docente.php">
            ...
            <div class="form-group">
                <label for="doc_number">Doc. Docente:</label>
                <input type="text" id="doc_number" name="doc_number" placeholder="123456789" required>
            </div>
            <div class="form-group">
                <label for="first_name">Primer Nombre:</label>
                <input type="text" id="first_name" name="first_name" placeholder="JOSÉ" required>
            </div>
            <div class="form-group">
                <label for="second_name">Segundo Nombre:</label>
                <input type="text" id="second_name" name="second_name" placeholder="ANDRÉS">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="second_last_name" name="second_last_name" placeholder="GARCÍA">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="specialty" name="specialty" placeholder="Matemáticas" required>
            </div>
            <div class="form-group">
                <button type="submit" class="button">Registrar Docente</button>
            </div>
        </form>
